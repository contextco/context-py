...
class ContextAPI(ContextAPIOperationsMixin):  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype conversation: context_api.aio.operations.ConversationOperations
    :ivar estimated: EstimatedOperations operations
    :vartype estimated: context_api.aio.operations.EstimatedOperations
    ...
    :vartype suggested: context_api.aio.operations.SuggestedOperations
