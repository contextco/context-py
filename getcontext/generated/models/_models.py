...
class Evaluation(_serialization.Model):
    ...
    :ivar reasoning:
    :vartype reasoning: ~context_api.models.EvaluationReasoning
    """
    ...
    _attribute_map = {
        ...
        "reasoning": {"key": "reasoning", "type": "EvaluationReasoning"},
    }
    ...
    def __init__(
        ...
        *,
        ...
        reasoning: Optional["_models.EvaluationReasoning"] = None,
        **kwargs: Any
    ) -> None:
        """
        ...
        :keyword reasoning:
        :paramtype reasoning: ~context_api.models.EvaluationReasoning
        """
        super().__init__(**kwargs)
...
class EvaluationReasoning(_serialization.Model):
    """EvaluationReasoning.

    :ivar result:
    :vartype result: list[~context_api.models.ReasoningResult]
    """

    _attribute_map = {
        "result": {"key": "result", "type": "[ReasoningResult]"},
    }

    def __init__(self, *, result: Optional[List["_models.ReasoningResult"]] = None, **kwargs: Any) -> None:
        """
        :keyword result:
        :paramtype result: list[~context_api.models.ReasoningResult]
        """
        super().__init__(**kwargs)
        self.result = result
...
class ReasoningResult(_serialization.Model):
    """ReasoningResult.
...
class ThreadMessage(_serialization.Model):
    """ThreadMessage.
    ...
    def __init__(self, *, rating: Optional[Union[int, "_models.Rating"]] = None, **kwargs: Any) -> None:
        """
        :keyword rating: Known values are: -1, 0, and 1.
        :paramtype rating: int or ~context_api.models.Rating
        """
