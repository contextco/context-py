...
def build_log_conversation_request(
    *, authorization: Optional[str] = None, tenant_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_log_conversation_upsert_request(
    *, authorization: Optional[str] = None, tenant_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_log_conversation_thread_request(
    *, authorization: Optional[str] = None, tenant_id: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_log_update_conversation_thread_request(  # pylint: disable=name-too-long
    id: str, *, authorization: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    # Construct URL
    _url = "/api/v1/log/conversation/thread/{id}"
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, "str"),
    }
...
class ContextAPIOperationsMixin(ContextAPIMixinABC):
    ...
    def conversation_series(
        ...
        cls: ClsType[_models.PathsPixtmzApiV1ConversationsSeriesGetResponses200ContentApplicationJsonSchema] = (
            kwargs.pop("cls", None)
        )
    ...
    def rating(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.PathsXq2NqjApiV1ConversationsSeriesRatingGetResponses200ContentApplicationJsonSchema] = (
            kwargs.pop("cls", None)
        )
    ...
    def volume(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models.Paths1Ola7DlApiV1ConversationsSeriesVolumeGetResponses200ContentApplicationJsonSchema] = (
            kwargs.pop("cls", None)
        )
    ...
    def conversation(
        ...
        deserialized = self._deserialize("ConversationResponse", pipeline_response.http_response)
    ...
    def conversations(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize(
            "PathsY5Azv9ApiV1ConversationsGetResponses200ContentApplicationJsonSchema", pipeline_response.http_response
        )
...
class EvaluationsOperations:
    ...
    def result(self, id: str, *, authorization: Optional[str] = None, **kwargs: Any) -> _models.EvaluationsRunResponse:
        ...
        deserialized = self._deserialize("EvaluationsRunResponse", pipeline_response.http_response)
...
class LogOperations:
    ...
    def conversation(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :keyword authorization: Default value is None.
        :paramtype authorization: str
        :keyword tenant_id: The tenant ID to log the conversation against. Default value is None.
        :paramtype tenant_id: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
    ...
    def conversation_thread(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models.PathsDo7Pm8ApiV1LogConversationThreadPostResponses201ContentApplicationJsonSchema] = (
            kwargs.pop("cls", None)
        )
    ...
    @overload
    def update_conversation_thread(  # pylint: disable=inconsistent-return-statements
        self,
        id: str,
        body: Optional[List[_models.ThreadMessage]] = None,
        *,
        authorization: Optional[str] = None,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :param id: The thread id of the conversation to update. Required.
        :type id: str
        :param body: Default value is None.
        :type body: list[~context_api.models.ThreadMessage]
        :keyword authorization: Default value is None.
        :paramtype authorization: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
    ...
    def update_conversation_thread(  # pylint: disable=inconsistent-return-statements
        self,
        id: str,
        body: Optional[Union[List[_models.ThreadMessage], IO[bytes]]] = None,
        *,
        authorization: Optional[str] = None,
        **kwargs: Any
    ) -> None:
        ...
        :param id: The thread id of the conversation to update. Required.
        :type id: str
        :param body: Is either a [ThreadMessage] type or a IO[bytes] type. Default value is None.
        :type body: list[~context_api.models.ThreadMessage] or IO[bytes]
        :keyword authorization: Default value is None.
        :paramtype authorization: str
        :return: None
        :rtype: None
        ...
        if isinstance(body, (IOBase, bytes)):
            ...
            if body is not None:
                _json = self._serialize.body(body, "[ThreadMessage]")
            else:
                _json = None

        _request = build_log_update_conversation_thread_request(
            id=id,
            authorization=authorization,
            content_type=content_type,
            json=_json,
    ...
    def test_sets(
        ...
        **kwargs: Any
        ...
        deserialized = self._deserialize("TestSetParams", pipeline_response.http_response)
