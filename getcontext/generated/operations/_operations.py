...
def build_update_conversation_thread_request(
    id: str, *, authorization: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class UpdateOperations:
    ...
    @overload
    def conversation_thread(  # pylint: disable=inconsistent-return-statements
        self,
        id: str,
    ...
    def conversation_thread(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        _request = build_update_conversation_thread_request(
            id=id,
            authorization=authorization,
            content_type=content_type,
            json=_json,
